...
ck_url='http://cknowledge.org/repo/web.php?native_action=show&native_module_uoa=program.optimization&scenario=a555738be4b65860'
ck_url1='http://cknowledge.org/repo/web.php?wcid=request:'
